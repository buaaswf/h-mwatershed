...
ImageVolume * testinterface()
{
	...
	//int l = 41, m = 41, n = 300; 
   int l= 281,m=481,n=501;
	//int l=201,m=201,n=851;
	RawImage test;
	...
	test.readImage(indata,"E:\\geodata\\mig.raw",l*m*n*sizeof(unsigned char));
	// test.readImage(indata,"E:\\geodata\\Probe_fault_Amp.probe.raw",l*m*n*sizeof(unsigned char));
	...
	//Raw *ret=(Raw *)doAnistropicykfour_diff(src,anis);
	// swf 20140415	   20141108
	//AnistropicI ani(10,30,2,1);
	//////doAnistropicI(src,ret,ani);
	//doAnistropicIYproqt(src,ret,ani,10,p);
	
	// end 20140415
	//TrilateralfilterI tri(16,7,7);
...
/*
swf delete to test anisotropic filter
...
ImageVolume * testlittledata()
{
	//int l = 4338, m = 3353, n = 3;
	//int l = 41, m = 41, n = 300; 
	//int lbig = 281, mbig = 481, nbig = 800;
	int lbig= 201,mbig=201,nbig=851;
	int l=200,m=200,n=nbig;
	...
	//test.readImage(indata,"F:\\lab\\VTKproj\\mig.raw",l*m*n*sizeof(unsigned char));//E:\geo\0000geoimageprov2\data
	//test.readImage(indata,"F:\\1385afwatersmooth.raw",l*m*n*sizeof(unsigned char));
	//test.readImage(indata,"F:\\origon200mig50_50_200-anistropic.raw",lbig*mbig*nbig);	   //E:\geodata
	test.readImage(indata, "F:\\filterd\\pro-sharpen-201-201-851.raw"/*"E:\\geodata\\Probe_fault_Amp.probe.raw"*/, lbig*mbig*nbig);  //F:\\filterd
